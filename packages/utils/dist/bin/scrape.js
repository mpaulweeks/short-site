...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var urls, vimeo, allInfos, validInfos;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                urls = sampleLinks;
                vimeo = new vimeo_1.VimeoClient();
                return [4 /*yield*/, asyncMap(urls, function (url) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, vimeo.get(url)];
            ...
            case 1:
                allInfos = _a.sent();
                validInfos = allInfos.filter(function (i) { return i; });
